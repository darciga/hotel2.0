...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-11-2013 a las 03:12:19
...
--
CREATE DATABASE IF NOT EXISTS `sistema_reservacion` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
...
INSERT INTO `clientes` (`id_cliente`, `nombres`,`apellidos`, `user`, `pass`, `email`, `tel`,`direccion`,`ciudad`,`cp`,`estado`,`pais`) VALUES
                      (1, 'Dante Omar ', 'Arciga Camarena', 'darciga', '123456', 'dante.omar.arciga@gmail.com', '3531208323','Esmeralda 8','Jiquilpan','59510','Michoacan','Mexico');
...
(2, 'Habitacion 2', 2, 'Ocupada', 'Descripcion Habitacion 2', 'img2'),
...
(6, 'Habitacion 6', 6, 'Mantenimiento', 'Descripcion Habitacion 6', 'img6'),
