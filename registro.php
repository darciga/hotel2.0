	...
	<body>
		...
		<div class="container-fluid">
			<div class="span12">
				<div class="row">
					<div class="span9">
						<form class="form-horizontal" method="post" action="crearcuenta.php">
							<br />
							<br />
							...
							<div class="row">
								...
								<div class="span3">
									<label>
										<select>
											<option />Sr. <option />Sra. <option />Srta.
										</select> </label>
								</div>
							...
							<div class="row">
								...
								<div class="span3">
									<label>Dirección 										<textarea class="address_box" rows="3"></textarea> </label>
								</div>
							...
							<div class="row">
								<div class="span9">
									<br />
									<a href="book-pay.php" class="btn btn-primary btn-large book-now pull-right" >Registro</a>
									<br />
									<br />
								</div>
							</div>
