		...
		<h1>Habitaciones y Suites</h1>
			<br />		            
              <ul class="nav nav-tabs">
                <li class="active"><a href="#habeco" data-toggle="tab">Hab. Económica</a></li>
                <li><a href="#habnor" data-toggle="tab">Hab. Normal</a></li>
                <li><a href="#suite" data-toggle="tab">Suite</a></li>
                <li><a href="#jsuite" data-toggle="tab">Junior Suite</a></li>
              </ul>
              <div id="" class="tab-content">
        <div class="tab-pane active in" id="habeco">
			...
			<div class="span4">
                ...
                <div class="tab-pane fade" id="habnor">
                ...
                <div class="tab-pane fade" id="jsuite">
                  <form class="form-horizontal" action='crearcuenta.php' method="POST">
                  	<fieldset>
                  		<div id="legend">
                        <legend class="">Crea Una Cuenta</legend>
