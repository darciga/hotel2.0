		...
		<div class="row">
				...
				<form class="form-horizontal" />
					...
					<fieldset>
						...
						<div class="row">
							<div class="span9">
								<br />
								<a href="book-pay.php" class="btn btn-primary btn-large book-now pull-right">Continue</a>
								<br />
								<br />
							</div>
						</div>
			...
			<div class="span3">
				...
				<p>
					...
					<div class="pull-left">Arrival : <i>Thu 10, Jan 2013</i></div><br />
